...
public class MenuViewController implements Serializable{
	...
	public void showSprints() {
        addMessage("Show sprints feature: under construction!", "TO DO!");
    }
	
	public void showFilterableProjects() {
		addMessage("Show filterable projects to edit feature: under construction!", "TO DO!");
	}
